...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/devalue/index.js';
import destr from 'file:///Users/aniruddh/BlocSoc/new/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/aniruddh/BlocSoc/new/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/unctx/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/aniruddh/BlocSoc/new/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/aniruddh/BlocSoc/new/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Users/aniruddh/BlocSoc/new/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aniruddh/BlocSoc/new","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aniruddh/BlocSoc/new/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aniruddh/BlocSoc/new/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aniruddh/BlocSoc/new/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/aniruddh/BlocSoc/new/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _rORKvE5Nwg = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/aniruddh/BlocSoc/new";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _QnxLzEpPPy = (nitroApp) => {
...
const _fPBnhkiTAN = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _pAgc8N = lazyEventHandler(() => {
...
const _lazy_Di97H3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Di97H3, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _pAgc8N, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Di97H3, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/aniruddh/BlocSoc/new/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/aniruddh/BlocSoc/new/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
